...
public class TripAToB
{
    ...
    private static final String RESULT_PRINT_FORMAT = "Leaving the city A at %02d:%02d:%02d, you wil arrive city B at %02d:%02d:%02d";
    ...
    public static void main(String [] args)
    {
        ...
        if(secondsForCityB > SECONDS_IN_ONE_DAY){
            daysTrip = secondsForCityB / SECONDS_IN_ONE_DAY;
        }
